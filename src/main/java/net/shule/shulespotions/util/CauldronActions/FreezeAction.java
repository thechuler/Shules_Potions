...
public class FreezeAction implements CauldronAction{
    ...
    public FreezeAction(int expectedTemperature) {
    ...
    public boolean canTrigger(CauldronActionContext ctx) {
        ...
        if (ctx.cauldron.getBlockState().getValue(PotionCauldron.STATE) != CauldronState.COLD) {
            ctx.cauldron.setTemperature(0);
            return false;
        }
