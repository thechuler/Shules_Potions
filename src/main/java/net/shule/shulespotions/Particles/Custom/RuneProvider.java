...
public class RuneProvider implements ParticleProvider<SimpleParticleType> {
    private final SpriteSet sprites;

    public RuneProvider(SpriteSet sprites) {
    ...
    public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double r, double g, double b) {
        return new RuneParticle(level, x, y, z, r, g, b, sprites);
    }
}
