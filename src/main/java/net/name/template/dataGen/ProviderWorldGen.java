...
import net.name.template.worldgen.ModBiomeModifiers;
import net.name.template.worldgen.ModConfiguredFeatures;
import net.name.template.worldgen.ModPlacedFeatures;
...
public class ProviderWorldGen extends DatapackBuiltinEntriesProvider {
    ...
    public ProviderWorldGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(Template.MODID));
    }
}
